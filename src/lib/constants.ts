...
// Fallbacks
export const shopInitial = {
  id: "shop",
  // Welcome
  welcome_badge: "Welcome to Padel Batu Alam Permai",
  welcome_heading: "Gear Up in Our Padel Shop",
  welcome_description:
    "From top-rated rackets to accessories, we've got everything you need to succeed and enhance your game.",
  welcome_image_1: "",
  welcome_image_2: "=",
  welcome_subheading: "Discover Your Perfect Padel Racket",
  welcome_subdescription:
  ...
  // CTAs
  cta_primary_text: "WhatsApp",
  cta_primary_href: "#contact",
  cta_secondary_text: "Book Now",
  cta_secondary_href: "#booking",
  // Products section
  products: [],
  created_at: "",
  updated_at: "",
