        ...
        <CardHeader>
          <div className="flex items-center justify-between gap-2">
            ...
            <div className="flex flex-wrap items-center justify-end gap-2">
              ...
              />
              <Button onClick={openGalleryDialog} className="gap-2">
        ...
        <DialogContent onOpenAutoFocus={(e) => e.preventDefault()} className="max-w-sm">
          ...
          <div className="space-y-4">
            <div>
              <Label>Badge</Label>
              <Input
                value={tempGallery.badge}
                onChange={(e) =>
                  setTempGallery({ ...tempGallery, badge: e.target.value })
                }
            ...
            <div>
              <Label>Heading</Label>
              <Input
                value={tempGallery.heading}
                onChange={(e) =>
                  setTempGallery({ ...tempGallery, heading: e.target.value })
                }
        ...
        <DialogContent onOpenAutoFocus={(e) => e.preventDefault()} className="max-w-sm">
          ...
          <div className="space-y-4">
            <div>
              ...
              <Input
                value={tempGallery.note.title}
                onChange={(e) =>
                  setTempGallery({
                    ...tempGallery,
                    note: { ...tempGallery.note, title: e.target.value },
                  })
                }
            ...
            <div>
              ...
              <Textarea
                value={tempGallery.note.description}
                onChange={(e) =>
                  setTempGallery({
                    ...tempGallery,
                    note: { ...tempGallery.note, description: e.target.value },
                  })
                }
